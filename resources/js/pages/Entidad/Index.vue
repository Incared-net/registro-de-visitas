		    	...
		    	<div class="col-12">
			     	<div class="card">
			     	   <div class="card-header bg bg-info">
			     	   		<b><i class="fas fa-bookmark"></i> Entidad </b>
			     	   </div>
		              <div class="card-body">
...
<script>
	...
	import FormModal from '@/components/entidad/Form.vue';
		 	...
		 	createform(){
		   	...
		   	createdCell(cell, cellData, rowData) {
		            ...
		            let instance = new actions({
		                propsData: {
		                	id:rowData.id,
		                	url_delete:route('entidad.delete'),
		                },
		            });
		            instance.$mount();
		            let me = this;
		        	instance.$on('edit_emit', function(event) {
		        		...
		        		me.form = rowData
		             	me.urlform = route('entidad.update')
		             	me.tipeform = 'update'
		             	me.tipemessage = `Actualizar entidad ${rowData.id} `
		             	me.componentKey += 1
		             	me.showModal=true
		        	})
